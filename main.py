...
try:
    ...
    try:
        ...
        #     create_table_query = "CREATE TABLE  `car`(id int AUTO_INCREMENT," \
        #                          " name varchar(32)," \
        #                          " password varchar(32)," \
        ...
        # insert data
        # with connection.cursor() as cursor:
        #     cursor.execute("INSERT INTO `car` (name, password, email) VALUES ('Anna', 'qwerty', 'anna@gmail.com')")
        #     # cursor.execute("INSERT INTO `car` (name) VALUES ('Fedor')")
        #     connection.commit()
